...
fetch('Img/treelove.svg')
  ...
  .then(svgText => {
    ...
    const heartPaths = allPaths.filter(el => {
      ...
      return style.includes('#a96257') || style.includes('#C1321F');
    });
...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la niña que ilumnino mi vida:\n\nRecuerdo la primera vez que te vi en aquel curso para mi eras una chica igual que las demas pero.. a lo largo de esos dias te fui conociendo mas y hay fue donde empezo mi gusto por ti tu manera de tratarme tu sonrisa y esos ojos como zafiros deslumbrantes \n\nGracias por acompañarme en cada paso, por entenderme incluso en silencio, y por llenar mis días de amor.\n\nTe amo más de lo que las palabras pueden expresar mi "medio metro".`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho amor, tu niño pequeño🥺";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-04-06T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-04-06T00:00:00');
